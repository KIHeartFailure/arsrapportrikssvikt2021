...
tabvars <- c(
  "vtype", "sex", "age", "ef_cat3", "FUNCTION_CLASS_NYHA",
...
default_kable(tab1,
  font_size = 6,
  caption = "Karaktäristika för patienter registrerade med ett index besök under 2021",
  escape = TRUE
)
```
...
default_kable(tab1,
  font_size = 6,
  caption = "Karaktäristika för patienter registrerade med ett index besök under 2021 uppdelat på kön",
  escape = TRUE
