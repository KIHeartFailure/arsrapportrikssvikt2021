...
legend("topright", levels(stat2$hfdur), fill = global_colsblue[c(3, 6)], border = global_colsblue[c(3, 6)], bty = "n", cex = cexmy)
...
posarrow <- -42.3
arrows(b[1], posarrow, b[3], posarrow, xpd = TRUE, code = 1, length = 0.1)
arrows(b[7], posarrow, b[10], posarrow, xpd = TRUE, code = 2, length = 0.1)

arrows(b[13], posarrow, b[14], posarrow, xpd = TRUE, code = 1, length = 0.1)
arrows(b[20], posarrow, b[21], posarrow, xpd = TRUE, code = 2, length = 0.1)
```
