```{r tgtid, cache=cacheon, fig.width=6, fig.height=5, fig.cap=paste0("Täckningsgrad 2003-", global_year)}
...
```{r tgmap, fig.cap=paste0("Täckningsgrad ", global_year, " uppdelat på region (karta)"), cache=cacheon, fig.show='hold', out.width="50%", fig.subcap=c('Prevalent', 'Incident'), fig.ncol=2}
