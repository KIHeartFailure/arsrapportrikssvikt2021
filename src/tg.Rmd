```{r tgovertime, cache=cacheon, fig.width=6, fig.height=5, fig.cap="Täckningsgrad 2003-2021"}
...
```{r geoprevinc, fig.cap="Täckningsgrad per region (karta)", cache=cacheon, dependson="tglan", fig.show='hold', out.width="50%", fig.subcap=c('Prevalent', 'Incident'), fig.ncol=2}
