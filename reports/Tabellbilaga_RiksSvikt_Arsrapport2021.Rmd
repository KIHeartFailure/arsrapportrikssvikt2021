...
piefunc(var = "vtype", type = c("Uppföljning 3 månader"))
...
barfunc(var = "location", type = "Index", mycols = c(global_colsblue[3], global_colsblue[6], global_colsblue[8]))
```             
...
barfunc(var = "vtype", type = c("Index", "Uppföljning 3 månader", "Uppföljning 1 år", "Uppföljning 2+ år"), 
        mycols = c(global_colsblue[4], global_colsblue[8]))
```             
